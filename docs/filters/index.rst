...
This filters simply denies all logging events. It has no configurable 
parameters.
...
The following filter configuration will deny all logging events with level DEBUG. It will remain 
neutral for others.
